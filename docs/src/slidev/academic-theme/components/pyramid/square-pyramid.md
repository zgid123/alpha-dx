...
**When to use**: When presenting hierarchical stages, tiered architectures, research levels, or capability tiers in academic and technical decks. Supports 1 to 6 square layers.

## Presentation Preview

<SquarePyramidDemo theme="academic" />
...
<SquarePyramid>
  <SquarePyramidStack>
    <SquarePyramidStackTitle>01 Problem Definition</SquarePyramidStackTitle>
    <SquarePyramidStackContent>
      Formalize domain constraints and research objectives.
    </SquarePyramidStackContent>
  </SquarePyramidStack>
  <SquarePyramidStack>
    <SquarePyramidStackTitle>02 Methodology</SquarePyramidStackTitle>
    <SquarePyramidStackContent>
      Implement the proposed algorithm with reproducible pipelines.
    </SquarePyramidStackContent>
  </SquarePyramidStack>
  <SquarePyramidStack>
    <SquarePyramidStackTitle>03 Empirical Study</SquarePyramidStackTitle>
    <SquarePyramidStackContent>
      Conduct empirical evaluation across standard academic benchmarks.
    </SquarePyramidStackContent>
  </SquarePyramidStack>
  <SquarePyramidStack>
    <SquarePyramidStackTitle>04 Discussion</SquarePyramidStackTitle>
    <SquarePyramidStackContent>
