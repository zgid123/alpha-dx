...
The `shifting-intro` layout coordinates an animated multi-stage slide opening: on click 0, the first heading starts centered on the slide; on click 1, the heading smoothly shifts upward into standard title position while revealing the remaining slide body content.

## Presentation Preview

<LayoutDemo layout="shifting-intro" theme="academic" />
