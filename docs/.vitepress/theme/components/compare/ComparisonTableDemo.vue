...
import ComparisonTable from '@alphacifer/slidev-addon-theme/components/compare/comparison-table/ComparisonTable.vue';
import ComparisonTableCell from '@alphacifer/slidev-addon-theme/components/compare/comparison-table/ComparisonTableCell.vue';
import ComparisonTableCol from '@alphacifer/slidev-addon-theme/components/compare/comparison-table/ComparisonTableCol.vue';
import ComparisonTableCols from '@alphacifer/slidev-addon-theme/components/compare/comparison-table/ComparisonTableCols.vue';
import ComparisonTableRow from '@alphacifer/slidev-addon-theme/components/compare/comparison-table/ComparisonTableRow.vue';
import ComparisonTableRows from '@alphacifer/slidev-addon-theme/components/compare/comparison-table/ComparisonTableRows.vue';
import { ref } from 'vue';
...
<template>
  <SlidevMockup :theme="props.theme">
    <ComparisonTable v-if="mode === 'default'" />
