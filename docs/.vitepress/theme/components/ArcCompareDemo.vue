...
import ArcCompare from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompare.vue';
import ArcCompareBadge from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareBadge.vue';
import ArcCompareCallout from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareCallout.vue';
import ArcCompareContent from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareContent.vue';
import ArcCompareContents from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareContents.vue';
import ArcCompareHeading from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareHeading.vue';
import ArcCompareLeft from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareLeft.vue';
import ArcCompareRight from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareRight.vue';
import ArcCompareTitle from '@alphacifer/slidev-addon-theme/components/arc-compare/ArcCompareTitle.vue';
import { ref } from 'vue';
...
<template>
  <SlidevMockup :theme="props.theme">
    <ArcCompare :count="count" :animation="animation">
