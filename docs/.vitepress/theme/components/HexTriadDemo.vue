...
import HexTriad from '@alphacifer/slidev-addon-theme/components/hex-triad/HexTriad.vue';
import HexTriadBadge from '@alphacifer/slidev-addon-theme/components/hex-triad/HexTriadBadge.vue';
import HexTriadCallout from '@alphacifer/slidev-addon-theme/components/hex-triad/HexTriadCallout.vue';
import HexTriadContent from '@alphacifer/slidev-addon-theme/components/hex-triad/HexTriadContent.vue';
import HexTriadHeading from '@alphacifer/slidev-addon-theme/components/hex-triad/HexTriadHeading.vue';
import { ref } from 'vue';
...
const title = ref('Engineering Pillars');
const subtitle = ref('Core values guiding our codebase');
...
<template>
  <SlidevMockup :theme="props.theme">
    <template #default="{ isFullscreen }">
      <div :class="{ 'hex-triad-demo-preview': !isFullscreen }">
        <HexTriad
          :title="title"
          :subtitle="subtitle"
          :animation="animation"
    ...
    <template #controls>
      <div class="slidev-mockup__control-group">
        <label for="hex-title" class="slidev-mockup__label">Title:</label>
        <input
          id="hex-title"
          v-model="title"
      ...
      <div class="slidev-mockup__control-group">
        <label for="hex-subtitle" class="slidev-mockup__label">Subtitle:</label>
        <input
          id="hex-subtitle"
          v-model="subtitle"
          class="slidev-mockup__input"
