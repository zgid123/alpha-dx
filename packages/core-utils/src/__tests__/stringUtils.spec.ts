...
describe('#combine', () => {
  describe('when first param is undefined', () => {
    it('returns empty string', () => {
      expect(combine(undefined)).toBe('');
    });
  });

  describe('when first param is string', () => {
    it('returns that string', () => {
      expect(combine('test')).toBe('test');
    });
  });

  describe('when trim option is true', () => {
    it('trims spaces', () => {
      expect(
        combine(
          {
  ...
  describe('when the list strings has undefined', () => {
    it('ignores undefined value', () => {
      expect(combine('lorem', undefined, 'ipsum')).toBe('lorem ipsum');
    });
  });

  describe('when the list strings has empty string', () => {
